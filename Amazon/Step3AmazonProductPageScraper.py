# To scrape the resulting Amazon product page we need to populate our
#callback parse_product_data(), which will parse the data from the Amazon
# product page after Scrapy has recieved a response.
